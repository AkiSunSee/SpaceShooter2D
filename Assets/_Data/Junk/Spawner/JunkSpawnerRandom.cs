...
public class JunkSpawnerRandom : AkiBehaviour
{
    ...
    protected virtual void LoadJunkSpawnerCtrl(){
        ...
        Debug.Log(transform.name + ": LoadJunkSpawnerCtr", gameObject);
    }
    ...
    protected virtual void JunkSpawning(){
        ...
        Transform randomJunk = this.junkSpawnerCtrl.JunkSpawner.GetRandomPrefab();
        Transform obj = this.junkSpawnerCtrl.JunkSpawner.Spawn(randomJunk, pos, rot);
